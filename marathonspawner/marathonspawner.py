...
class MarathonSpawnerException(Exception):
    pass
...
class MarathonSpawner(Spawner):
    ...
    def start(self):
        ...
        while True:
            ...
            if app_info is None:
                raise MarathonSpawnerException("Application %s is lost", self.app_id)
            elif app_info.instances == 0:
                raise MarathonSpawnerException("No instance for application %s", self.app_id)
